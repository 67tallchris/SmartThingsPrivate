 ...
 */
 metadata {
	definition (name: "Fibaro Motion Sensor MOVEMENT", namespace: "smartthings", author: "SmartThings") {
	...
	tiles {
		...
		main(["motion", "acceleration", "illuminance"])
		details(["motion", "acceleration", "battery", "illuminance", "configure"])
	}
}
...
def test() {
    ...
    cmds << zwave.configurationV1.configurationSet(scaledConfigurationValue: 0, parameterNumber: 40, size: 2).format() 
    ...
    cmds << zwave.configurationV1.configurationSet(scaledConfigurationValue: 0, parameterNumber: 42, size: 2).format() 
